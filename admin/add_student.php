...
<table border="0" class="table">
  ...
  <tr>
    ...
    <td width="213"><input type="text" name="stname" class="form-control" placeholder="enter your name" required/></td>
  </tr>
  <tr>
    <th scope="row">Enter Your Email </th>
    <td><input type="email" name="eid" class="form-control" placeholder="enter your email" required/></td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="number" name="mobile" class="form-control" placeholder="enter your mobile" required/></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input type="date" name="dob" class="form-control" placeholder="enter your D.O.B" required/></td>
  </tr>
  
   <tr>
    <th scope="row">Upload Your Pic</th>
    <td><input type="file" name="pic" class="form-control" placeholder="Upload your Pic" required/></td>
  </tr>
