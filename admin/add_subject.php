...
<form method="POST" enctype="multipart/form-data">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="213"><input type="text" name="subname" class="form-control" required/></td>
  </tr>
  <tr>
    <th width="237" scope="row">Lecture/Week </th>
    <td width="213"><input type="number" name="lpw" class="form-control" required/></td>
  </tr>
  <tr>
    ...
    <td width="213"><input class="form-check-input" type="radio" name="type" value="Theory" checked>
		...
		<input class="form-check-input" type="radio" name="type" value="Lab" required>
