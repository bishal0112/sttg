    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
              ...
              <p class="pStyle"> <span>Hello Admin</span>
...
<a href="logout.php">Logout</a></span>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background-color:#000; font-size: 2rem;" >
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                   <div class="col-lg-12" style="background-color:#eee; height:580px; width:1100px;"  align="center" margin-top="20px">
				...
				?>
                   ...
                   <font color="#000011" size="+9" face="Lucida Console, Monaco, monospace">Welcome Admin</font><br/>
                        <img src="img/admin.jpg" class="img-responsive" alt="Cinque Terre" width="250" height="250" style="margin-top: 80px; margin-left: 23px;">
                <?php }?>
