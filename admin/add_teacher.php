...
<table border="0" class="table">
  ...
  <tr>
    ...
    <td><input type="number" name="m" class="form-control" placeholder="Enter your mobile" required/></td>
  </tr>
  
  <tr>
    <th scope="row">Enter Your Address</th>
    <td><input type="text" name="a" class="form-control" placeholder="Enter your address" required/></td>
  </tr>
