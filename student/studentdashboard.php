    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
              ...
              <p class="pStyle"> <span>Hello <?php echo $_SESSION['name'];?>
              </span>
...
<a href="logout.php">Logout</a></span>
            ...
            <!-- Top Menu Items -->
                            <?php
								// $arr=scandir($email);
								// $img=$arr[2];
								$path="image/$email/$pic";
                                // $ii = "/image/bishal@gmail.com/pic2.jpg"
							?>                  
            <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background: #000; font-size:2rem;">
                 <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row">
                   <div class="col-lg-12" style="background: #555;"  align="center" margin-top="20px">
				...
				?>
                        ...
                        <img src="img/sLogo.png" class="img-responsive" alt="Cinque Terre" width="500" height="500" style="margin-top: 10px; margin-left: 23px;">
                        <img src="img/sLogo.png" class="img-responsive" alt="Cinque Terre" width="500" height="100" style=" margin-left: 23px;">
                <?php }?>
